...
EOF
	...
	psql --dbname=$POSTGRES_DB --username=postgres --host=localhost -c 'ALTER TABLE user_roles ADD CONSTRAINT "ID_PKEY" PRIMARY KEY REFERENCES users (id), PRIMARY KEY (roleId,userId));'
